...
function CheckoutSummary(props) {
    ...
    return ( <
        ...
        br / > {
            getAtt('custom:street')
        } < br / > {
            getAtt('custom:city')
        }, {
            getAtt('custom:state')
        } {
            getAtt('custom:postcode')
        } <
        br / > {
            getAtt('custom:country')
        } <
        /NormalText> < /
        Grid.Column > <
        /Grid.Row> <
        ...
        br / >
        <
        Input fluid icon = 'credit card'
        iconPosition = 'left'
        placeholder = 'Credit card...'
        onChange = {
            (event, data) => props.onCardUpdate(data)
        }
        /> < /
        Grid.Column > <
        /Grid.Row> <
